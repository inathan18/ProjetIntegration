...
<div class="container-fluid h-100">
    ...
    @method('PATCH')
        ...
        <div class="p3">
            ...
            <input class="form-control" type="text" id="personneContact" name="personneContact" value="{{old('personneContact', $fournisseur->personneContact)}}">
        </div>

        <div class="p3">
            <label class="form-label" for="website">Site Web : </label>
            <input class="form-control" type="text" id="website" name="website" value="{{old('website', $fournisseur->website)}}">
        </div>
